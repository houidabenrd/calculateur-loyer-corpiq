...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    step2: {
      ...
      important: 'Important:',
      importantNote: 'Only the portion of the increase in taxes and insurance that exceeds the average annual variation of the general CPI for Quebec over the last 3 years is taken into account in the adjustment calculation. If your taxes or insurance decrease, the reduction is fully passed on.',
    ...
    step4: {
      newExpenses: {
        ...
        note: 'Note:',
        noteText: 'Unlike major repairs and improvements, new expenses are not amortized over 20 years. The full expense for the reference year is divided by 12 months and distributed according to the proportional share of the concerned dwelling.',
      ...
      totalSection4: 'Adjustment for new expenses arising from the implementation of a service or the addition of an accessory or dependency',
    ...
    step5: {
      ...
      summary: {
        ...
        monthlyAdjustment: 'Monthly adjustment',
        baseAdjustment: 'Base rent adjustment',
  ...
  fr: {
    ...
    step2: {
      ...
      important: 'Important:',
      importantNote: 'Seule la portion de l\'augmentation des taxes et assurances qui dépasse la variation annuelle moyenne de l\'IPC général pour le Québec des 3 dernières années est prise en compte dans le calcul de l\'ajustement. Si vos taxes ou assurances diminuent, la réduction est entièrement répercutée.',
    ...
    step4: {
      newExpenses: {
        ...
        note: 'Note:',
        noteText: 'Contrairement aux réparations et améliorations majeures, les nouvelles dépenses ne sont pas amorties sur 20 ans. La dépense complète pour l\'année de référence est divisée par 12 mois et répartie selon la quote-part du logement concerné.',
      ...
      totalSection4: 'Ajustement pour les nouvelles dépenses découlant de la mise en place d\'un service ou de l\'ajout d\'un accessoire ou d\'une dépendance',
    ...
    step5: {
      ...
      summary: {
        ...
        description: 'Description',
        monthlyAdjustment: 'Ajustement mensuel',
        baseAdjustment: 'Ajustement de base du loyer',
